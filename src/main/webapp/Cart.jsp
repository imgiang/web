                                        ...
                                        <th scope="row">
                                            <div class="p-2">
                                                ...
                                                <div class="ml-3 d-inline-block align-middle">
                                                    <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block" style="text-decoration: none;">${o.name}</a></h5><span class="text-muted font-weight-normal font-italic"></span>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="p-4">
                            <ul class="list-unstyled mb-4">
                                ...
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Phí vận chuyển</strong><strong>${vat}</strong></li>
